...
CREATE TABLE `recent_match` (
  ...
  KEY `FK_MEMBER_TO_RECENT_MATCH_2` (`user_id2`),
  ...
  CONSTRAINT `FK_MEMBER_TO_RECENT_MATCH_2` FOREIGN KEY (`user_id2`) REFERENCES `member` (`member_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_roles` (
  ...
  KEY `user_roles_login_id_idx` (`login_id`),
  CONSTRAINT `user_roles_login_id` FOREIGN KEY (`login_id`) REFERENCES `member` (`login_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
